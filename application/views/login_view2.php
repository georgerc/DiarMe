...
<div class="w3-container w3-center login-box" style="margin:auto">
    ...
    <div class="w3-third  w3-card-8"   style="width:100%;background-color: rgba(0,0,0,0.6);">
      ...
      <?php echo form_open('verifylogin'); ?>       
        <input class="w3-input" type="text" id="username" placeholder="Username" required style="margin:auto;">
                
      <br>

      </div>
      <div class="formular-children w3-margin" >      
        <input class="w3-input" type="password" id="password" placeholder="Password" required style="margin:auto;width:92%">
      </div> 
      ...
      <div class="w3-row">
        ...
        <div class="w3-third  w3-center  w3-margin-bottom">
        <input type="button" data-toggle="modal" data-target="#myModal" class="w3-btn  w3-hover-white w3-padding ">
